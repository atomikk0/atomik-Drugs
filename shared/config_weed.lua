...
WeedLocales = {
    ...
    ['processmenulabel'] = 'Ot İşle.',
    ['processmenuheader1'] = 'Düşük Kaliteli Ot İşle',
    ['processmenutext1'] = 'Gerekli: <br> 5x Düşük Kaliteli Ot Yaprağı',
    ['processmenuheader2'] = 'Orta Kaliteli Ot İşle',
    ['processmenutext2'] = 'Gerekli: <br> 5x Orta Kaliteli Ot Yaprağı',
    ['processmenuheader3'] = 'Yüksek Kaliteli Ot İşle',
    ['processmenutext3'] = 'Gerekli: <br> 5x Yüksek Kaliteli Ot Yaprağı',
    ['packetmenulabel'] = 'Ot Paketle.',
    ['packetmenuheader1'] = 'Düşük Kaliteli Ot Paketle',
    ['packetmenutext1'] = 'Gerekli: <br> 10x İşlenmiş Düşük Kaliteli Ot',
    ['packetmenuheader2'] = 'Orta Kaliteli Ot Paketle',
    ['packetmenutext2'] = 'Gerekli: <br> 10x İşlenmiş Orta Kaliteli Ot',
    ['packetmenuheader3'] = 'Yüksek Kaliteli Ot Paketle',
    ['packetmenutext3'] = 'Gerekli: <br> 10x İşlenmiş Yüksek Kaliteli Ot'
}
